  ...
  return (
    <nav className="flex justify-between h-[80px] bg-gradient-to-r from-[#2d2d2d] to-[#0000000e]">
      ...
      <div className="group/item w-[200px] h-[fit-content] right-[0px] bg-[#2d2d2d] flex flex-col absolute md:flex-row md:relative justify-between md:w-[900px] md:h-[80px] md:bg-[transparent] ">
        ...
        {/* Download CV button */}
        <div className="items-center px-[30px] h-[0px] flex justify-center invisible group-hover/item:visible group-hover/item:h-[inherit] py-[.2rem] md:visible md:h-[inherit] md:py-[0]">
